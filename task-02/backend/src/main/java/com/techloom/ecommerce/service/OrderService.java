...
import com.techloom.ecommerce.dto.OrderDtos.*;
import com.techloom.ecommerce.entity.*;
...
public class OrderService {
    ...
    /**
     * Cancels an order and reverses whatever stock/payment state it was holding.
     * RESERVED -> stock reservation is released. PAID -> stock is restored
     * (restocked) and a refund record is created (see RefundService).
     */
    @Transactional
    ...
    /** Reverses confirmPaidAndDeductStock: adds the quantities back to totalStock. */
    private void restockPaidOrderItems(Order order) {
